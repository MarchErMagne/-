...
def campaign_actions_keyboard(campaign_id: int, status: str) -> InlineKeyboardMarkup:
    ...
    builder.add(InlineKeyboardButton(text="◀️ Назад", callback_data="campaigns_list"))
...
def contacts_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🏷 Управление тегами", callback_data="contacts_tags")],
            [InlineKeyboardButton(text="🚫 Черный список", callback_data="contacts_blacklist")],
            [InlineKeyboardButton(text="◀️ Назад", callback_data="back_to_menu")]
        ]
    )
